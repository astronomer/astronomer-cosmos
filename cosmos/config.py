...
class RenderConfig:
    ...
    :param disable_owner_inheritance: A boolean that allows users to disable the owner inheritance from dbt models to airflow tasks. Defaults to False.
    """
    ...
    disable_owner_inheritance: bool | None = False
