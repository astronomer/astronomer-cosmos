...
# Directory names that are generated by dbt or version-control tooling rather than authored by the
# user, and therefore excluded by default from the dbt project content hash (cosmos/versioning.py)
DEFAULT_PROJECT_HASH_EXCLUDED_DIRS = frozenset(
