...
class DbtNode:
    ...
    fqn: list[str] | None = None  # Fully Qualified Name from dbt manifest
        ...
        try:
            ...
            try:
                node = DbtNode(
                    ...
                    fqn=node_dict.get("fqn"),  # Store FQN from dbt ls output if available
                )
        ...
        with self.project.manifest_path.open() as fp:
            ...
            for unique_id, node_dict in resources.items():
                ...
                node = DbtNode(
                    ...
                    fqn=node_dict.get("fqn"),  # Store FQN from manifest if available
                )
