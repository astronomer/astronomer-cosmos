...
class AbstractDbtLocalBase(AbstractDbtBase):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # Handle deprecated install_deps argument only in __init__
        if install_deps is not None:
            warnings.warn(
                message="'install_deps' is deprecated and will be removed in Cosmos 2.0. Use 'install_dbt_deps' instead.",
                category=DeprecationWarning,
                stacklevel=2,
            )
            self.install_dbt_deps = install_deps
        else:
