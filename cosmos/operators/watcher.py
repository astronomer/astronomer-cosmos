...
from cosmos.operators.kubernetes import DbtBuildKubernetesOperator, DbtRunKubernetesOperator
...
class DbtConsumerKubernetesWatcherSensor(BaseSensorOperator, DbtRunKubernetesOperator):
    ...
    # Same as DbtConsumerWatcherSensor - candidate to be generalised!
    def __init__(
        self,
        *,
    ...
    # same as original DbtConsumerWatcherSensor
    @staticmethod
