...
use_dataset_airflow3_uri_standard = conf.getboolean("cosmos", "enable_dataset_airflow3_uri", fallback=conf.getboolean("cosmos", "use_dataset_airflow3_uri_standard", fallback=False))
