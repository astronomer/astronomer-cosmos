"""
DAG to test watcher retry behaviour with SUBPROCESS invocation mode.

Two models: model_a (succeeds) and model_f (fails - references nonexistent column).
Uses InvocationMode.SUBPROCESS instead of DBT_RUNNER.
"""
...
example_watcher_failing_tests_subprocess = DbtDag(
    ...
    catchup=False,
    dag_id="example_watcher_failing_tests_subprocess",
