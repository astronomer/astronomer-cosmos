...
redirects = {
    ...
    "configuration/callbacks": "../guides/callbacks/callbacks.html",
    ...
    "configuration/task-display-name": "../guides/cosmos_devex/task-display-name.html",
    ...
    "getting_started/aws-container-run-job": "../guides/run_dbt/airflow-worker/aws-container-run-job.html",
