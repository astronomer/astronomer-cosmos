...
.. table::
   ...
   `Language <https://airflow.apache.org/docs/apache-airflow/stable/public-airflow-interface.html>`__  `Language <https://docs.getdbt.com/docs/introduction#why-use-dbt>`__                                  Programming or declarative language used to define pipelines and steps.              In dbt, users write SQL, YML and Python to define the steps of a pipeline. Airflow expects steps and pipelines are written in Python.
   ...
   `Connection <https://airflow.apache.org/docs/apache-airflow/stable/howto/connection.html>`__        `Profile <https://docs.getdbt.com/docs/local/profiles.yml>`__                                        Configuration to connect to databases or other services
   `Providers <https://airflow.apache.org/docs/apache-airflow-providers/>`__                           `Adapter <https://docs.getdbt.com/guides/adapter-creation>`__                                        Additional Python libraries that support specific databases or services
   =================================================================================================== ==================================================================================================== ==================================================================================== ======================================================================================================================================================
