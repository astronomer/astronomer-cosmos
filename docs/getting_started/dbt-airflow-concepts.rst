...
.. table::
   ...
   =================================================================================================== ==================================================================================================== ==================================================================================== ======================================================================================================================================================
   `Dag <https://airflow.apache.org/docs/apache-airflow/stable/core-concepts/dags.html>`__             `Workflow <https://docs.getdbt.com/docs/introduction>`__                                             Pipeline (Directed Acyclic Graph) that contains a group of steps                       Airflow expects upstream tasks to have passed to run downstream tasks. dbt can run a subset of tasks assuming upstream tasks were run.
