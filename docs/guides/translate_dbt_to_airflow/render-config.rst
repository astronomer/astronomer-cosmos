...
- ``seed_rendering_behavior``: Determines how seed nodes are rendered and run (ALWAYS, WHEN_SEED_CHANGES, RENDER_ONLY, NONE). Defaults to "ALWAYS". See :doc:`Managing seeds <managing-seeds>` for more information.
