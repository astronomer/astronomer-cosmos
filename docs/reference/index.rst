...
- `CosmosConfig <configs/cosmos-conf.html>`_: This page lists available `Apache Airflow® 3 <https://airflow.apache.org/>`_ configurations that affect ``astronomer-cosmos`` behavior. You can set them in the ``airflow.cfg`` file or using environment variables.
