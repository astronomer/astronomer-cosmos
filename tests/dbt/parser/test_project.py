...
from cosmos.providers.dbt.parser.project import DbtModel, DbtModelConfig, DbtProject
...
def test_dbt_model_multi_tag(tmp_path: Path):
    ...
    dbt_model = DbtModel("jaffle_shop_revenue", sql_model)
...
def test_dbt_project():
    ...
    # TODO would love to test this but I believe sources has bugs at the moment
    #  assert stg_order_config.upstream_models == {"schema"}
