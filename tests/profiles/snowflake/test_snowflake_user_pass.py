...
def test_authenticator_absent_when_not_set(
    mock_snowflake_conn: Connection,
) -> None:
    """
    Tests that authenticator is omitted from the profile when not set on the connection.
    """
...
def test_client_session_keep_alive_absent_when_not_set(
    mock_snowflake_conn: Connection,
) -> None:
    """
    Tests that client_session_keep_alive is omitted from the profile when not set.
    """
    profile_mapping = get_automatic_profile_mapping(mock_snowflake_conn.conn_id)
